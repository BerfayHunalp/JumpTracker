...
const _currentSeasonIncidents = [
  ...
  EawsIncident('2025-11-01', 'Vertainspitze', 'Italy', 5, 'Mountaineering', 'Persistent weak layer'),
  EawsIncident('2025-12-22', 'Alagna Valsesia', 'Italy', 1, 'Backcountry', 'Persistent weak layer'),
  EawsIncident('2025-12-26', 'La Plagne', 'France', 1, 'Backcountry', 'Wind slab'),
  EawsIncident('2025-12-26', 'Montgenevre', 'France', 1, 'Backcountry', 'Persistent weak layer'),
  EawsIncident('2025-12-26', 'Valloire', 'France', 1, 'Backcountry', 'Persistent weak layer'),
  ...
  EawsIncident('2026-01-26', 'Tignes', 'France', 1, 'Off-piste', 'Persistent weak layer'),
  EawsIncident('2026-01-29', 'Cervieres', 'France', 1, 'Hiking', 'New snow'),
  EawsIncident('2026-01-29', 'Cervieres', 'France', 1, 'Backcountry', 'New snow'),
  ...
  EawsIncident('2026-02-06', 'Tupà', 'Slovakia', 2, 'Mountaineering', 'Persistent weak layer'),
  EawsIncident('2026-02-07', 'Saint-Veran', 'France', 2, 'Backcountry', 'New snow'),
  EawsIncident('2026-02-07', 'Pizzo Meriggio', 'Italy', 2, 'Backcountry', 'Persistent weak layer'),
